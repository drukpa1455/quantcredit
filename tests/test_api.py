...
class ApiTests(unittest.TestCase):
  def test_exposes_memorable_research_entrypoints(self) -> None:
    ...
    self.assertEqual(qc.forecast.__module__, "quantcredit.api")
    self.assertEqual(qc.history.__module__, "quantcredit.api")
    self.assertEqual(qc.project.__module__, "quantcredit.api")
    self.assertEqual(qc.reveal.__module__, "quantcredit.api")
    self.assertEqual(qc.select.__module__, "quantcredit.api")
    self.assertEqual(qc.split.__module__, "quantcredit.api")
    self.assertEqual(qc.waterfall.__module__, "quantcredit.api")
